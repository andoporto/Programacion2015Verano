/*
* NEW BrowserCompAPI version 1.0.0.39
...
absMessaging.onTopicMsg.addListener(conduit.currentApp.appId+"_tabs_"+params,function(data){
data = JSON.parse(data);
...
paramCallback(data.userData, cb);
});
}
...
conduit.tabs.onRequest.addListener("EBCallBackMessageReceived",function(data){
...
var EBMessageData = strScript.match(/EBCallBackMessageReceived\((.*)\)/)[1];
conduit.tabs.executeScript(tabId || null, { code: "conduitPage.sendRequest('EBCallBackMessageReceived',"+EBMessageData+")" });
}
